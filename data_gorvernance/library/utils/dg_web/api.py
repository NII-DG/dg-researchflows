...
class Api():
    ...
    def validate(self, base_url: str, grdm_token: str, project_id: str, govrun_token: Optional[str] = None, govsheet: Optional[dict] = None, metadata: Optional[dict] = None) -> dict:
        """検証する関数です。
